...
router.get("/fetchDynamo", async (req, res) => {
  ...
  //   //   user_id: "007", // Replace with dynamic user ID if needed
  //   // },
  //   keyConditionExpression: "user_id = :007",
  // };
  const dbParams = {
  ...
  dynamoDB.scan(dbParams, (err, data) => {
    if (err) {
      ...
      //   scanDynamoDB(params);  // Recursive call
      // }
    }
  });
  ...
  //try {
    ...
    // const fileBytes = readFileBytes(s3Data.Body);
